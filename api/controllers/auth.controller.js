...
export const signin = async (req, res, next) => {
	...
	try {
		...
		const token = jwt.sign({ id: validUser._id }, "kdsavhdlkvniCIHOIENWCJKWVNLLKVJBFDJKHFWO");
...
export const google = async (req, res, next) => {
	try {
		...
		if (user) {
			const token = jwt.sign({ id: user._id }, "kdsavhdlkvniCIHOIENWCJKWVNLLKVJBFDJKHFWO");
			//removing the password from the res.body sent as cookie
			...
			await newUser.save();
			const token = jwt.sign({ id: newUser._id }, "kdsavhdlkvniCIHOIENWCJKWVNLLKVJBFDJKHFWO");
			//removing the password from the res.body sent as cookie
